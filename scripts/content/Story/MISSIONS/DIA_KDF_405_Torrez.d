...
func void DIA_Torrez_PERM_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Torrez_PERM_04_02");	//Innos buď pochválen, bratře.
		AI_Output(self,other,"DIA_Torrez_PERM_04_03");	//Právě se zabývám magií třetího kruhu.
		AI_Output(self,other,"DIA_Torrez_PERM_04_04");	//Také zkoumám účinky některých magických amuletů a prstenů.
		AI_Output(self,other,"DIA_Torrez_PERM_04_05");	//Existuje celá řada různých magických artefaktů, které tě posilní.
		AI_Output(self,other,"DIA_Torrez_PERM_04_06");	//Někteřé tě udělají silnějším, jiné vytrvalejším a další zvýší tvé magické schopnosti.
		AI_Output(self,other,"DIA_Torrez_PERM_04_07");	//Jinak věnuji veškerou svou pozornost Innosovi, bratře.
	};
};
...
func void KDF_405_Torrez_GREET_Info()
{
	...
	AI_Output(self,other,"KDF_405_Torrez_GREET_Info_04_03");	//Naše runy a svitky prodávám výhradně Innosovým služebníkům.
	Log_CreateTopic(GE_TraderOC,LOG_NOTE);
	B_LogEntry(GE_TraderOC,"Torrez prodává SVITKY a RUNY. Během dne zůstává na nádvoří. Neprodá mi je však, dokud se nepřipojím ke kruhu Mágů Ohně.");
	Log_CreateTopic(GE_TeacherOC,LOG_NOTE);
	B_LogEntry(GE_TeacherOC,"Torrez mi může ukázat, jak zvýšit svoji MAGICKOU ENERGII. Přes den bývá na nádvoří.");
};
