...
func void Info_Jackal_PAYDAY_Info()
{
	...
	{
		AI_Output(self,other,"Info_Jackal_PAYDAY_11_05");	//Podívejme. Bývalý člen našeho tábora.
		AI_Output(self,other,"Info_Jackal_PAYDAY_11_06");	//Kdyby jsi nás nezradil, byl by jsi mezi námi - vítězi !
	}
	else
	{
...
instance INFO_JACKAL_GILBERT(C_Info)
{
	...
	permanent = 0;
	description = "Znáš nějakého chlápka jménem Gilbert?";
};
...
{
	AI_Output(other,self,"Info_Jackal_Gilbert_07_01");	//Znáš nějakého chlápka jménem Gilbert?
	AI_Output(self,other,"Info_Jackal_Gilbert_07_02");	//Pamatuju si ho. Kdysi to byl kopáč, žil na trhovišti.
	AI_Output(self,other,"Info_Jackal_Gilbert_07_03");	//Pak se však s Rudobarony dostal do problémů, netuším o co šlo.
	AI_Output(self,other,"Info_Jackal_Gilbert_07_04");	//Vím jenom, že Gilbert se vypařil z tábora.
	AI_Output(self,other,"Info_Jackal_Gilbert_07_05");	//Od té doby jsem o něm neslyšel.
	B_LogEntry(CH1_GILBERT,"Jackal, jeden ze strážců, si Gilberta dobře pamatuje. Vybavuje si, že Gilbert utekl protože se dostal do problémů s Rudobarony.");
};
