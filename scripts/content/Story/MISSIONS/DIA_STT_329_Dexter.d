...
{
	AI_Output(other,self,"Info_Dexter_Gilbert_07_01");	//Znáš Gilberta?
	AI_Output(self,other,"Info_Dexter_Gilbert_07_02");	//Ne, to jméno nic neříká.
	B_LogEntry(CH1_GILBERT,"Dexter nezná Gilberta.");
};
...
{
	AI_Output(other,self,"STT_329_Dexter_Sect_15_00");	//Co tu děláš?
	AI_Output(self,other,"STT_329_Dexter_Sect_11_01");	//Raven, jeden z Rudobaronů, mne vyslal do bažin.
	AI_Output(self,other,"STT_329_Dexter_Sect_15_02");	//Říkal jsem si, že určitě neuškodí si u Ravena udělat dobré jméno.
	AI_Output(self,other,"STT_329_Dexter_Sect_11_03");	//Můžeme obchodovat pokud máš zájem. Další důvod proč jsem zde.
};
