...
func void DIA_Milten_Letter_Give()
{
	...
	B_UseFakeScroll();
	B_GiveXP(XP_XardasLetter);
	B_LogEntry(CH1_MESSAGEKDF,"Milten, nejmladší z Mágů Ohně, převzal můj dopis a odevzdal ho muži jménem Corristo. Zmínil také někoho jménem Xardas, ten se prý odvrátil od Řádu a studoval černou magii.");
...
func int DIA_Milten_NochEinBrief_Condition()
{
	...
	//BUG [Fawkes]: nekontroluje sa, ci hrac skutocne ma dopis
...
func void Info_Milten_LSRISK_Info()
{
	...
	B_LogEntry(CH5_Uriziel,"Dokázal jsem přesvědčit Miltena, aby mi pomohl přenést energii do meče. Setkáme se u úpatí rudné haldy mágů Vody.");
