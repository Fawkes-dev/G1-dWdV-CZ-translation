...
func void Info_FreemineOrc_SHADOWBEAST2_Info()
{
	...
	B_LogEntry(CH4_UluMulu,"Tarrok potřebuje pro Ulu-Mulu roh Stínové šelmy. Ty žijí hlavně v temných lesích a jeskyních. Pokud vím, největší les v Kolonii je mezi Starým táborem a Táborem v bažinách.");
};
...
func void Info_FreemineOrc_SWAMPSHARK2_Info()
{
	...
	B_LogEntry(CH4_UluMulu,"Tarrok potřebuje pro Ulu-Mulu zuby bažinatého žraloka. V táboře Bratrstva jsou tuny příšer tohoto druhu.");
};
...
func void Info_FreemineOrc_TROLL2_Info()
{
	...
	B_LogEntry(CH4_UluMulu,"Tarrok potřebuje pro Ulu-Mulu kly trolů. Tyhle potvory žijí v severních horách kolonie. Měl bych tam prohledat kaňony.");
};
