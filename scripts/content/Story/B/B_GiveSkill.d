	...
	if((TAL_Wert + 1) == NEW_Wert)
	{
		if(typ.lp >= LP_Cost)
		{
			...
			if(tal == NPC_TALENT_1H)
			{
				...
				PrintScreen("Naučil ses: Boj s jednoručními zbraněmi",-1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if(tal == NPC_TALENT_2H)
			{
				...
				PrintScreen("Naučil ses: Boj s obouručními zbraněmi",-1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if(tal == NPC_TALENT_BOW)
			{
				...
				PrintScreen("Naučil ses: Lukostřelbu",-1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if(tal == NPC_TALENT_CROSSBOW)
			{
				...
				PrintScreen("Naučil ses: Střelbu z kuše",-1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if(tal == NPC_TALENT_PICKLOCK)
			{
				...
				PrintScreen("Naučil ses: Vybírání zámků",-1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if(tal == NPC_TALENT_PICKPOCKET)
			{
				...
				PrintScreen("Naučil ses: Vybírání kapes",-1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if(tal == NPC_TALENT_MAGE)
			{
				Npc_SetTalentSkill(typ,NPC_TALENT_MAGE,NEW_Wert);
				PrintScreen("Naučil ses: Další magický kruh",-1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if(tal == NPC_TALENT_SNEAK)
			{
				Npc_SetTalentSkill(typ,NPC_TALENT_SNEAK,NEW_Wert);
				PrintScreen("Naučil ses: Plížení",-1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if(tal == NPC_TALENT_REGENERATE)
			{
				Npc_SetTalentSkill(typ,NPC_TALENT_REGENERATE,NEW_Wert);
				PrintScreen("Naučil ses: Alchymii",-1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if(tal == NPC_TALENT_FIREMASTER)
			{
				Npc_SetTalentSkill(typ,NPC_TALENT_FIREMASTER,NEW_Wert);
				PrintScreen("Naučil ses: Kování",-1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else if(tal == NPC_TALENT_ACROBAT)
			{
				Npc_SetTalentSkill(typ,NPC_TALENT_ACROBAT,NEW_Wert);
				PrintScreen("Naučil ses: Akrobacie",-1,-1,"FONT_OLD_20_WHITE.TGA",2);
				return 1;
			}
			else
			{
